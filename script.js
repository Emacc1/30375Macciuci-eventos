...
document.getElementById(`body`).appendChild(cajaMensaje);
document.getElementById(`body`).appendChild(button1);
document.getElementById(`body`).appendChild(button2);
document.getElementById(`body`).appendChild(button3);
document.getElementById(`body`).appendChild(button0);
cajaMensaje.innerHTML = mensajeBusqueda2;
...
function buscarPropiedad(ar0, ar1, ar2) {
    if (ar1 == 1) {
